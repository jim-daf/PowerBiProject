...
This project is about retrieving data from my chess profile in chess.com and visualizing them in power bi.
...
The code that i wrote in python programming language to retrieve the chess and nba data is in the power bi presentation
